...
/*!
	...
	\param bluetoothAdapterInfo		A pointer to a \ref UNICORN_BLUETOOTH_ADAPTER_INFO structure that receives information about the used Bluetooth adapter.
...
*/
UNICORN_API int UNICORN_GetAvailableDevices(UNICORN_DEVICE_SERIAL* availableDevices, uint32_t* availableDevicesCount, BOOL onlyPaired);
